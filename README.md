Beginner's app. Made slight changes to this app, to create a simple quiz-app for my 6 year old kid to play on TV with Amazon Fire TV stick.
...
The Android Trivia is an application that asks the user trivia questions about Android development.  It makes use of the Navigation component within Jetpack to move the user between different screens.  Each screen is implemented as a Fragment.
